...
// Index
passGesture.addCurl(Finger.Index, FingerCurl.NoCurl, 0.75)
passGesture.addDirection(Finger.Index, FingerDirection.HorizontalLeft, 0.5)

// Pinky
passGesture.addCurl(Finger.Pinky, FingerCurl.NoCurl, 0.75)
passGesture.addDirection(Finger.Pinky, FingerDirection.HorizontalLeft, 0.5)

// Middle
passGesture.addCurl(Finger.Middle, FingerCurl.NoCurl, 0.75)
passGesture.addDirection(Finger.Middle, FingerDirection.HorizontalLeft, 0.5)

//Ring
passGesture.addCurl(Finger.Ring, FingerCurl.NoCurl, 0.75)
